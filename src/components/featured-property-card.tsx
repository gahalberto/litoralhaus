...
import { formatPrice, PROPERTY_TYPE_LABELS, REGION_LABELS } from "@/lib/property-config";
    ...
    >
      ...
      <div className="relative aspect-4/3 w-full overflow-hidden bg-muted">
        ...
        <div className="absolute left-3 top-3 flex gap-1.5">
          <span className="flex items-center gap-1 rounded-none bg-amber-400 px-2 py-0.5 font-inter text-[9px] font-black uppercase tracking-widest text-stone-950">
            ★ Recomendado
          </span>
        </div>
        ...
        <button
          ...
          className="absolute right-3 top-3 flex h-8 w-8 items-center justify-center rounded-full bg-white shadow-md transition-transform hover:scale-110"
        >
          <Heart
            size={14}
            className={cn("transition-colors", favorited ? "fill-red-500 text-red-500" : "text-gray-500")}
          />
        </button>
      </div>
